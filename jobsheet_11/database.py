...
if __name__ == "__main__":
    print("--- Memulai Tes Fungsi database.py ---")
    status = setup_database_initial()
    if status:
        print("-> TES BERHASIL: Modul database.py dapat terhubung ke DB dengan aman!")
    else:
        print("-> TES GAGAL: Terjadi kendala saat menghubungkan ke database.")